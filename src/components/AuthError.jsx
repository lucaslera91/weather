  ...
  return (
    <div>
        <div className='text-light'>
            ...
            <p>Ayuda adicional: https://support.apple.com/es-es/HT207092</p>
            <p>Otros posibilidades:</p>
            <p>Adnroid: https://support.google.com/nexus/answer/3467281?hl=es</p>
            <p>Chrome: https://help.headspace.com/hc/es-419/articles/360046918374-Habilitar-la-configuraci%C3%B3n-de-ubicaci%C3%B3n-en-navegadores-de-dispositivos-m%C3%B3viles</p>
            <p>FireFox:https://support.mozilla.org/en-US/kb/does-firefox-share-my-location-websites</p>
            <p>Safari: https://support.apple.com/es-lamr/guide/mac-help/mh35873/mac</p>
        </div>
    </div>
  )
}
